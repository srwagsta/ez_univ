"""
Production settings for EZ_university project.
...
#                          default='EZ_university <noreply@example.com>')
# EMAIL_SUBJECT_PREFIX = env('DJANGO_EMAIL_SUBJECT_PREFIX', default='[EZ_university]')
